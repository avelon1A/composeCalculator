...
class CalculatorViewModel: ViewModel() {
    ...
    fun onAction(action: CalculatorAction){
        when(action){
            ...
            is CalculatorAction.Calculate -> performCalcultion()
        }
    }
    ...
    private fun performDelete() {
        when{ state.number2.isNotBlank() -> state = state.copy(
